          ...
          <div className="container-fluid py-4">
                ...
                <ul className="app-line-breadcrumbs mb-0 d-flex list-unstyled">
                  <li className="me-2">
                    <NavLink to="/projects" className="f-s-14 f-w-500 text-muted">
                      <Stack size={16} className="ph-duotone me-1" /> Projets
                    </NavLink>
                  </li>
                  <li className="text-muted">/</li>
                  <li className="ms-2">
                    <span className="f-s-14 f-w-500 text-primary">Détails</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="row g-4">
              <div className="col-md-12 col-lg-6 col-xxl-4 order-1">
                <div className="card shadow-sm border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  <div className="card-header bg-gradient-primary text-white py-4">
                    <h4 className="m-0" style={{ fontWeight: '600' }}>Détails du Projet</h4>
                  </div>
                  <div className="card-body p-5">
                    <table className="table table-borderless align-middle mb-0">
                      <tbody>
                        <tr>
                          <td className="f-w-600 text-muted" style={{ fontSize: '1.1rem' }}>Nom</td>
                        ...
                        <tr>
                          <td className="f-w-600 text-muted" style={{ fontSize: '1.1rem' }}>Début</td>
                          <td className="text-end text-primary" style={{ fontSize: '1.1rem' }}>{formatDate(project.startDate)}</td>
                        </tr>
                        <tr>
                          <td className="f-w-600 text-muted" style={{ fontSize: '1.1rem' }}>Fin</td>
                          <td className="text-end text-danger" style={{ fontSize: '1.1rem' }}>{formatDate(project.endDate)}</td>
                        </tr>
                        <tr>
                          <td className="f-w-600 text-muted" style={{ fontSize: '1.1rem' }}>Statut</td>
                        ...
                        <tr>
                          <td className="f-w-600 text-muted" style={{ fontSize: '1.1rem' }}>Progression</td>
                          <td className="text-end">
              ...
              <div className="col-md-6 col-lg-6 col-xxl-4 order-2">
                <div className="card shadow-sm border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  <div className="card-header bg-gradient-dark text-white py-4 d-flex align-items-center justify-content-between">
                    <h4 className="m-0" style={{ fontWeight: '600' }}>Équipe du Projet</h4>
                    <button
              ...
              <div className="col-md-6 col-lg-6 col-xxl-4 order-3">
                <div className="card shadow-sm border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  <div className="card-header bg-gradient-primary text-white py-4">
                    <h4 className="m-0" style={{ fontWeight: '600' }}>Gestion du Projet</h4>
                  </div>
                  <div className="card-body p-5">
                    <div className="mb-4 border-bottom pb-3">
                      <h6 className="f-w-600 mb-3 text-dark">
                        <i className="ti ti-target me-2 text-primary"></i> Objectifs du Projet
                      </h6>
                    ...
                    <div className="mb-4 border-bottom pb-3">
                      <h6 className="f-w-600 mb-3 text-dark">
                        <i className="ti ti-checklist me-2 text-success"></i> Livrables
                      </h6>
                      <ul className="list-group list-group-flush">
                    ...
                    <div className="mb-3">
                      <h6 className="f-w-600 mb-3 text-dark">
                        <i className="ti ti-calendar me-2 text-danger"></i> Date limite
                      </h6>
              ...
              <div className="col-md-6 col-lg-6 col-xxl-4 order-4">
                <div className="card shadow-sm border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
                  <div className="card-header bg-gradient-dark text-white py-4">
                    <h4 className="m-0" style={{ fontWeight: '600' }}>À propos du Projet</h4>
                  </div>
                  <div className="card-body p-5">
                    <div className="mb-3">
                      <h6 className="text-dark">Description du Projet</h6>
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '15px' }}>
                  <div className="modal-header bg-light border-bottom-0 py-3">
                    <h5 className="modal-title text-dark">Ajouter un membre à l’équipe</h5>
                    <button
                      type="button"
                      className="btn-close"
                      onClick={() => setShowAddMemberModal(false)}
                  ...
                  <div className="modal-body p-4">
                    <form className="app-form" onSubmit={addTeamMember}>
                      <div className="mb-4">
                        <label htmlFor="memberSelect" className="form-label f-w-600 text-dark">Sélectionner un membre</label>
                        <select
