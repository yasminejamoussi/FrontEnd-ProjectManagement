...
const ProjectsDashboard = () => {
  ...
  const [newTask, setNewTask] = useState({ title: '', description: '', status: 'To Do', priority: 'Medium', assignedTo: [] });
                    ...
                    <div className="card-footer">
                      <div className="row align-items-center">
                        ...
                        <div className="col-6 text-end">
                          <NavLink to={`/project-details/${project._id}`} className="btn btn-outline-primary btn-sm me-2">
                            <i className="ti ti-eye f-s-16"></i> Ouvrir
                          </NavLink>
                          <NavLink to={`/kanban/${project._id}`} className="btn btn-outline-info btn-sm">
                            <i className="ti ti-list f-s-16"></i> Voir les tâches
                          </NavLink>
                        </div>
                      </div>
                    </div>
